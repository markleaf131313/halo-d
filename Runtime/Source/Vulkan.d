...
struct VkSemaphore_T;           alias VkSemaphore           = ulong;
struct VkCommandBuffer_T;       alias VkCommandBuffer       = VkCommandBuffer_T*;
struct VkFence_T;               alias VkFence               = ulong;
struct VkDeviceMemory_T;        alias VkDeviceMemory        = ulong;
struct VkBuffer_T;              alias VkBuffer              = ulong;
struct VkImage_T;               alias VkImage               = ulong;
struct VkEvent_T;               alias VkEvent               = ulong;
struct VkQueryPool_T;           alias VkQueryPool           = ulong;
struct VkBufferView_T;          alias VkBufferView          = ulong;
struct VkImageView_T;           alias VkImageView           = ulong;
struct VkShaderModule_T;        alias VkShaderModule        = ulong;
struct VkPipelineCache_T;       alias VkPipelineCache       = ulong;
struct VkPipelineLayout_T;      alias VkPipelineLayout      = ulong;
struct VkRenderPass_T;          alias VkRenderPass          = ulong;
struct VkPipeline_T;            alias VkPipeline            = ulong;
struct VkDescriptorSetLayout_T; alias VkDescriptorSetLayout = ulong;
struct VkSampler_T;             alias VkSampler             = ulong;
struct VkDescriptorPool_T;      alias VkDescriptorPool      = ulong;
struct VkDescriptorSet_T;       alias VkDescriptorSet       = ulong;
struct VkFramebuffer_T;         alias VkFramebuffer         = ulong;
struct VkCommandPool_T;         alias VkCommandPool         = ulong;
...
static if((void*).sizeof == 8) { struct VkSurfaceKHR_T; alias VkSurfaceKHR = VkSurfaceKHR_T*; }
else                           { alias VkSurfaceKHR = ulong; }
