...
struct ImVector(T)
{
    ...
    ref inout(T) opIndex(int i) inout { assert(i < Size); return Data[i]; }
...
struct ImFontAtlas
{
    ...
    void GetTexDataAsRGBA32(ubyte** out_pixels, int* out_width, int* out_height, int* out_bytes_per_pixel) { ImFontAtlas_GetTexDataAsRGBA32(&this, out_pixels, out_width, out_height, out_bytes_per_pixel); }
    void SetTexID(void* id)  { ImFontAtlas_SetTexID(&this, id); }
...
struct ImGuiIO
{
    ...
    void AddInputCharactersUTF8(const(char*) utf8_chars) { ImGuiIO_AddInputCharactersUTF8(utf8_chars); }
