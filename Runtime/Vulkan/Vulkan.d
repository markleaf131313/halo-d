...
@nogc nothrow pure:
    ...
    const( VkDeviceQueueCreateInfo )[]   queueCreateInfos() { return pQueueCreateInfos[0 .. queueCreateInfoCount]; }
    void                                 queueCreateInfos( const( VkDeviceQueueCreateInfo )[] value ) { pQueueCreateInfos = value.ptr; queueCreateInfoCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkCommandBuffer )[]       commandBuffers() { return pCommandBuffers[0 .. commandBufferCount]; }
    void                             commandBuffers( const( VkCommandBuffer )[] value ) { pCommandBuffers = value.ptr; commandBufferCount = value.length32; }
    const( VkSemaphore )[]           signalSemaphores() { return pSignalSemaphores[0 .. signalSemaphoreCount]; }
    void                             signalSemaphores( const( VkSemaphore )[] value ) { pSignalSemaphores = value.ptr; signalSemaphoreCount = value.length32; }
    const( VkSemaphore )[]           waitSemaphores() { return pWaitSemaphores[0 .. waitSemaphoreCount]; }
    void                             waitSemaphores( const( VkSemaphore )[] value ) { pWaitSemaphores = value.ptr; waitSemaphoreCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkSparseMemoryBind )[]  binds() { return pBinds[0 .. bindCount]; }
    void                           binds( const( VkSparseMemoryBind )[] value ) { pBinds = value.ptr; bindCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkSparseImageMemoryBind )[]  binds() { return pBinds[0 .. bindCount]; }
    void                                binds( const( VkSparseImageMemoryBind )[] value ) { pBinds = value.ptr; bindCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkSparseImageMemoryBindInfo )[]        imageBinds() { return pImageBinds[0 .. imageBindCount]; }
    void                                          imageBinds( const( VkSparseImageMemoryBindInfo )[] value ) { pImageBinds = value.ptr; imageBindCount = value.length32; }
    const( VkSparseBufferMemoryBindInfo )[]       bufferBinds() { return pBufferBinds[0 .. bufferBindCount]; }
    void                                          bufferBinds( const( VkSparseBufferMemoryBindInfo )[] value ) { pBufferBinds = value.ptr; bufferBindCount = value.length32; }
    const( VkSemaphore )[]                        signalSemaphores() { return pSignalSemaphores[0 .. signalSemaphoreCount]; }
    void                                          signalSemaphores( const( VkSemaphore )[] value ) { pSignalSemaphores = value.ptr; signalSemaphoreCount = value.length32; }
    const( VkSparseImageOpaqueMemoryBindInfo )[]  imageOpaqueBinds() { return pImageOpaqueBinds[0 .. imageOpaqueBindCount]; }
    void                                          imageOpaqueBinds( const( VkSparseImageOpaqueMemoryBindInfo )[] value ) { pImageOpaqueBinds = value.ptr; imageOpaqueBindCount = value.length32; }
    const( VkSemaphore )[]                        waitSemaphores() { return pWaitSemaphores[0 .. waitSemaphoreCount]; }
    void                                          waitSemaphores( const( VkSemaphore )[] value ) { pWaitSemaphores = value.ptr; waitSemaphoreCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkVertexInputAttributeDescription )[]  vertexAttributeDescriptions() { return pVertexAttributeDescriptions[0 .. vertexAttributeDescriptionCount]; }
    void                                          vertexAttributeDescriptions( const( VkVertexInputAttributeDescription )[] value ) { pVertexAttributeDescriptions = value.ptr; vertexAttributeDescriptionCount = value.length32; }
    const( VkVertexInputBindingDescription )[]    vertexBindingDescriptions() { return pVertexBindingDescriptions[0 .. vertexBindingDescriptionCount]; }
    void                                          vertexBindingDescriptions( const( VkVertexInputBindingDescription )[] value ) { pVertexBindingDescriptions = value.ptr; vertexBindingDescriptionCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkViewport )[]                viewports() { return pViewports[0 .. viewportCount]; }
    void                                 viewports( const( VkViewport )[] value ) { pViewports = value.ptr; viewportCount = value.length32; }
    const( VkRect2D )[]                  scissors() { return pScissors[0 .. scissorCount]; }
    void                                 scissors( const( VkRect2D )[] value ) { pScissors = value.ptr; scissorCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkPipelineColorBlendAttachmentState )[]  attachments() { return pAttachments[0 .. attachmentCount]; }
    void                                            attachments( const( VkPipelineColorBlendAttachmentState )[] value ) { pAttachments = value.ptr; attachmentCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkDynamicState )[]           dynamicStates() { return pDynamicStates[0 .. dynamicStateCount]; }
    void                                dynamicStates( const( VkDynamicState )[] value ) { pDynamicStates = value.ptr; dynamicStateCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkPipelineShaderStageCreateInfo )[]         stages() { return pStages[0 .. stageCount]; }
    void                                               stages( const( VkPipelineShaderStageCreateInfo )[] value ) { pStages = value.ptr; stageCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkPushConstantRange )[]    pushConstantRanges() { return pPushConstantRanges[0 .. pushConstantRangeCount]; }
    void                              pushConstantRanges( const( VkPushConstantRange )[] value ) { pPushConstantRanges = value.ptr; pushConstantRangeCount = value.length32; }
    const( VkDescriptorSetLayout )[]  setLayouts() { return pSetLayouts[0 .. setLayoutCount]; }
    void                              setLayouts( const( VkDescriptorSetLayout )[] value ) { pSetLayouts = value.ptr; setLayoutCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkDescriptorSetLayoutBinding )[]  bindings() { return pBindings[0 .. bindingCount]; }
    void                                     bindings( const( VkDescriptorSetLayoutBinding )[] value ) { pBindings = value.ptr; bindingCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkDescriptorPoolSize )[]  poolSizes() { return pPoolSizes[0 .. poolSizeCount]; }
    void                             poolSizes( const( VkDescriptorPoolSize )[] value ) { pPoolSizes = value.ptr; poolSizeCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkDescriptorSetLayout )[] setLayouts() { return pSetLayouts[0 .. descriptorSetCount]; }
    void                             setLayouts( const( VkDescriptorSetLayout )[] value ) { pSetLayouts = value.ptr; descriptorSetCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkImageView )[]     attachments() { return pAttachments[0 .. attachmentCount]; }
    void                       attachments( const( VkImageView )[] value ) { pAttachments = value.ptr; attachmentCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkAttachmentReference )[]  colorAttachments() { return pColorAttachments[0 .. colorAttachmentCount]; }
    void                              colorAttachments( const( VkAttachmentReference )[] value ) { pColorAttachments = value.ptr; colorAttachmentCount = value.length32; }
    const( VkAttachmentReference )[]  inputAttachments() { return pInputAttachments[0 .. inputAttachmentCount]; }
    void                              inputAttachments( const( VkAttachmentReference )[] value ) { pInputAttachments = value.ptr; inputAttachmentCount = value.length32; }
    const( uint32_t )[]               preserveAttachments() { return pPreserveAttachments[0 .. preserveAttachmentCount]; }
    void                              preserveAttachments( const( uint32_t )[] value ) { pPreserveAttachments = value.ptr; preserveAttachmentCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkAttachmentDescription )[]  attachments() { return pAttachments[0 .. attachmentCount]; }
    void                                attachments( const( VkAttachmentDescription )[] value ) { pAttachments = value.ptr; attachmentCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkClearValue )[]  clearValues() { return pClearValues[0 .. clearValueCount]; }
    void                     clearValues( const( VkClearValue )[] value ) { pClearValues = value.ptr; clearValueCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkRect2D )[]  deviceRenderAreas() { return pDeviceRenderAreas[0 .. deviceRenderAreaCount]; }
    void                 deviceRenderAreas( const( VkRect2D )[] value ) { pDeviceRenderAreas = value.ptr; deviceRenderAreaCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkRect2D )[]  splitInstanceBindRegions() { return pSplitInstanceBindRegions[0 .. splitInstanceBindRegionCount]; }
    void                 splitInstanceBindRegions( const( VkRect2D )[] value ) { pSplitInstanceBindRegions = value.ptr; splitInstanceBindRegionCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkPhysicalDevice )[]  physicalDevices() { return pPhysicalDevices[0 .. physicalDeviceCount]; }
    void                         physicalDevices( const( VkPhysicalDevice )[] value ) { pPhysicalDevices = value.ptr; physicalDeviceCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkInputAttachmentAspectReference )[]  aspectReferences() { return pAspectReferences[0 .. aspectReferenceCount]; }
    void                                         aspectReferences( const( VkInputAttachmentAspectReference )[] value ) { pAspectReferences = value.ptr; aspectReferenceCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( uint32_t )[]  correlationMasks() { return pCorrelationMasks[0 .. correlationMaskCount]; }
    void                 correlationMasks( const( uint32_t )[] value ) { pCorrelationMasks = value.ptr; correlationMaskCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkSwapchainKHR )[]  swapchains() { return pSwapchains[0 .. swapchainCount]; }
    void                       swapchains( const( VkSwapchainKHR )[] value ) { pSwapchains = value.ptr; swapchainCount = value.length32; }
    const( VkSemaphore )[]     waitSemaphores() { return pWaitSemaphores[0 .. waitSemaphoreCount]; }
    void                       waitSemaphores( const( VkSemaphore )[] value ) { pWaitSemaphores = value.ptr; waitSemaphoreCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkRectLayerKHR )[]  rectangles() { return pRectangles[0 .. rectangleCount]; }
    void                       rectangles( const( VkRectLayerKHR )[] value ) { pRectangles = value.ptr; rectangleCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkAttachmentReference2KHR )[]  colorAttachments() { return pColorAttachments[0 .. colorAttachmentCount]; }
    void                                  colorAttachments( const( VkAttachmentReference2KHR )[] value ) { pColorAttachments = value.ptr; colorAttachmentCount = value.length32; }
    const( VkAttachmentReference2KHR )[]  inputAttachments() { return pInputAttachments[0 .. inputAttachmentCount]; }
    void                                  inputAttachments( const( VkAttachmentReference2KHR )[] value ) { pInputAttachments = value.ptr; inputAttachmentCount = value.length32; }
    const( uint32_t )[]                   preserveAttachments() { return pPreserveAttachments[0 .. preserveAttachmentCount]; }
    void                                  preserveAttachments( const( uint32_t )[] value ) { pPreserveAttachments = value.ptr; preserveAttachmentCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkAttachmentDescription2KHR )[]  attachments() { return pAttachments[0 .. attachmentCount]; }
    void                                    attachments( const( VkAttachmentDescription2KHR )[] value ) { pAttachments = value.ptr; attachmentCount = value.length32; }
    const( uint32_t )[]                     correlatedViewMasks() { return pCorrelatedViewMasks[0 .. correlatedViewMaskCount]; }
    void                                    correlatedViewMasks( const( uint32_t )[] value ) { pCorrelatedViewMasks = value.ptr; correlatedViewMaskCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkFormat )[]  viewFormats() { return pViewFormats[0 .. viewFormatCount]; }
    void                 viewFormats( const( VkFormat )[] value ) { pViewFormats = value.ptr; viewFormatCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkValidationCheckEXT )[]  disabledValidationChecks() { return pDisabledValidationChecks[0 .. disabledValidationCheckCount]; }
    void                             disabledValidationChecks( const( VkValidationCheckEXT )[] value ) { pDisabledValidationChecks = value.ptr; disabledValidationCheckCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkIndirectCommandsLayoutTokenNVX )[]  tokens() { return pTokens[0 .. tokenCount]; }
    void                                         tokens( const( VkIndirectCommandsLayoutTokenNVX )[] value ) { pTokens = value.ptr; tokenCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkIndirectCommandsTokenNVX )[]  indirectCommandsTokens() { return pIndirectCommandsTokens[0 .. indirectCommandsTokenCount]; }
    void                                   indirectCommandsTokens( const( VkIndirectCommandsTokenNVX )[] value ) { pIndirectCommandsTokens = value.ptr; indirectCommandsTokenCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkRect2D )[]                             discardRectangles() { return pDiscardRectangles[0 .. discardRectangleCount]; }
    void                                            discardRectangles( const( VkRect2D )[] value ) { pDiscardRectangles = value.ptr; discardRectangleCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkDebugUtilsLabelEXT )[]             queueLabels() { return pQueueLabels[0 .. queueLabelCount]; }
    void                                        queueLabels( const( VkDebugUtilsLabelEXT )[] value ) { pQueueLabels = value.ptr; queueLabelCount = value.length32; }
    const( VkDebugUtilsLabelEXT )[]             cmdBufLabels() { return pCmdBufLabels[0 .. cmdBufLabelCount]; }
    void                                        cmdBufLabels( const( VkDebugUtilsLabelEXT )[] value ) { pCmdBufLabels = value.ptr; cmdBufLabelCount = value.length32; }
    const( VkDebugUtilsObjectNameInfoEXT )[]    objects() { return pObjects[0 .. objectCount]; }
    void                                        objects( const( VkDebugUtilsObjectNameInfoEXT )[] value ) { pObjects = value.ptr; objectCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( uint64_t )[]  drmFormatModifiers() { return pDrmFormatModifiers[0 .. drmFormatModifierCount]; }
    void                 drmFormatModifiers( const( uint64_t )[] value ) { pDrmFormatModifiers = value.ptr; drmFormatModifierCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkCoarseSampleLocationNV )[]  sampleLocations() { return pSampleLocations[0 .. sampleLocationCount]; }
    void                                 sampleLocations( const( VkCoarseSampleLocationNV )[] value ) { pSampleLocations = value.ptr; sampleLocationCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkCoarseSampleOrderCustomNV )[]  customSampleOrders() { return pCustomSampleOrders[0 .. customSampleOrderCount]; }
    void                                    customSampleOrders( const( VkCoarseSampleOrderCustomNV )[] value ) { pCustomSampleOrders = value.ptr; customSampleOrderCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkPipelineShaderStageCreateInfo )[]      stages() { return pStages[0 .. stageCount]; }
    void                                            stages( const( VkPipelineShaderStageCreateInfo )[] value ) { pStages = value.ptr; stageCount = value.length32; }
    const( VkRayTracingShaderGroupCreateInfoNV )[]  groups() { return pGroups[0 .. groupCount]; }
    void                                            groups( const( VkRayTracingShaderGroupCreateInfoNV )[] value ) { pGroups = value.ptr; groupCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkAccelerationStructureNV )[]  accelerationStructures() { return pAccelerationStructures[0 .. accelerationStructureCount]; }
    void                                  accelerationStructures( const( VkAccelerationStructureNV )[] value ) { pAccelerationStructures = value.ptr; accelerationStructureCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkVertexInputBindingDivisorDescriptionEXT )[]  vertexBindingDivisors() { return pVertexBindingDivisors[0 .. vertexBindingDivisorCount]; }
    void                                                  vertexBindingDivisors( const( VkVertexInputBindingDivisorDescriptionEXT )[] value ) { pVertexBindingDivisors = value.ptr; vertexBindingDivisorCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkRect2D )[]  exclusiveScissors() { return pExclusiveScissors[0 .. exclusiveScissorCount]; }
    void                 exclusiveScissors( const( VkRect2D )[] value ) { pExclusiveScissors = value.ptr; exclusiveScissorCount = value.length32; }
}
...
@nogc nothrow pure:
    ...
    const( VkValidationFeatureDisableEXT )[]  disabledValidationFeatures() { return pDisabledValidationFeatures[0 .. disabledValidationFeatureCount]; }
    void                                      disabledValidationFeatures( const( VkValidationFeatureDisableEXT )[] value ) { pDisabledValidationFeatures = value.ptr; disabledValidationFeatureCount = value.length32; }
    const( VkValidationFeatureEnableEXT )[]   enabledValidationFeatures() { return pEnabledValidationFeatures[0 .. enabledValidationFeatureCount]; }
    void                                      enabledValidationFeatures( const( VkValidationFeatureEnableEXT )[] value ) { pEnabledValidationFeatures = value.ptr; enabledValidationFeatureCount = value.length32; }
}
...
VkResult  vkRegisterObjectsNVX( VkDevice device, VkObjectTableNVX objectTable, uint32_t objectCount, const( VkObjectTableEntryNVX* )* ppObjectTableEntries, const( uint32_t )* pObjectIndices );
